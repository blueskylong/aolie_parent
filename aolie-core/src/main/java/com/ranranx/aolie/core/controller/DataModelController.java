...
import com.ranranx.aolie.core.service.SchemaService;
...
public class DataModelController {
    ...
    public Schema findSchemaInfo(@PathVariable Long schemaId, @PathVariable String version) {
        return schemaService.getSchema(schemaId, version);
    }
    ...
    public String saveSchema(@RequestBody Schema schema) {
        String info = service.saveSchema(schema);
    ...
    public boolean refreshCache(@PathVariable long schemaId, @PathVariable String version) {
        schemaService.initSchema(schemaId, version);
        return true;
    }
    ...
    public HandleResult deleteSchema(@PathVariable Long schemaId) {
        service.deleteSchemaForPublic(schemaId, SessionUtils.getLoginVersion());
        schemaService.refresh();
    ...
    public List<ReferenceDto> findReferenceData() {
        return schemaService.getReferenceDtos(SessionUtils.getLoginVersion());
    }
