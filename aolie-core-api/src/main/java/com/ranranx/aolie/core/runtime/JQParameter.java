...
public class JQParameter {
    ...
    public void setUiService(UiService uiService) {
        JQParameter.uiService = uiService;
    }

//    @Autowired
//    @ConditionalOnClass(name = "com.ranranx.aolie.core.AolieCoreApplication")
//    private void setService(UiService uiService) {
...
//    }
    ...
    public QueryParam getQueryParam() {
        ...
        long blockId = new Long(value);
        BlockViewer blockViewer = uiService.getViewerInfo(blockId, SessionUtils.getLoginVersion());
