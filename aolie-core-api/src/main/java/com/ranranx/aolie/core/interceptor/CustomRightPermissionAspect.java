...
import com.ranranx.aolie.common.annotation.CustomRightPermission;
import com.ranranx.aolie.common.exceptions.IllegalOperatorException;
import com.ranranx.aolie.common.exceptions.NotLoginException;
...
public class CustomRightPermissionAspect {
    ...
    @Pointcut("@annotation(com.ranranx.aolie.common.annotation.CustomRightPermission)")
