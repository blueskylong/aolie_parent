...
public class CommonUtils {
     ...
     * @return
     */
    public static Map<String, Object> convertToUnderline(Map<String, Object> map) {
        if (map == null || map.isEmpty()) {
            return map;
        }
        Map<String, Object> mapResult = new HashMap<>();
        ...
        while (it.hasNext()) {
            Map.Entry<String, Object> next = it.next();
            mapResult.put(convertToUnderline(next.getKey()), next.getValue());
        }
        return mapResult;
    }
