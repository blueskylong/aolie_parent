...
public class CustomDesignServiceImpl implements CustomDesignService {
    ...
    @Autowired
    private DmDataService modelApi;
    ...
    private HandleResult addTemplet(QrTempletQuery templetQuery) {
        ...
        insertParam.setObject(QueryConstants.QUERY_DEFAULT_SCHEMA_ID, templetQuery.getMainDto());
        ...
        insertParam.setObjects(QueryConstants.QUERY_DEFAULT_SCHEMA_ID, lstDetail);
